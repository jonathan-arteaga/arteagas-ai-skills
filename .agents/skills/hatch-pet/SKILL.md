---
name: hatch-pet
description: "Create, repair, validate, and package Codex-compatible v2 animated pets (8x11 atlas, 9 animation rows, 16 look directions). Use when the user invokes hatch-pet, or asks for a Codex pet, custom mascot, or spritesheet packaging."
license: Apache-2.0
metadata:
