# Pet repair and acceptance

Run command examples from the skill directory; `SKILL_DIR` refers to that directory, not this reference folder. Load only the sections needed by the active stage.
