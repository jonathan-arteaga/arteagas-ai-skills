# Requested Swift migration

Use this checklist only when migration is requested. Verify every feature against the installed compiler; do not enable flags or rewrite architecture during an unrelated edit.

# Migrating an existing codebase to Swift 6

Read this reference when enabling data-race safety on an existing project.
