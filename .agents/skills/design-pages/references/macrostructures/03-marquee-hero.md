...
> *"Type, set with care."* — design-pages Specimen — refusal of the verb, treats type as material
> *"A studio for what's next."* — italic editorial display, names the practice without explaining it
> *"Design like print: warm, off-register, intentional."* — design-pages Riso — declarative, three modifiers, full stop
