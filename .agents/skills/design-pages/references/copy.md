...
- *"Type, set with care."* — design-pages Specimen — three words; the comma is the design
...
- *"WE ARE A STUDIO. WE ARE NOT A PLATFORM."* — design-pages Meridian (test 04) — defines by refusal, all caps
...
- *"NO COMPROMISE."* — design-pages Brutal — two words; the period is the design
...
- *"Soft, but exact."* — design-pages Hum — two short adjectives, one comma, full stop
...
- *"A study in the senses."* — design-pages Atelier — single nominal phrase, comma-free
- *"A page should arrive like a person — composed, deliberate, in good clothes."* — design-pages Atelier — analogy treats the page as social
- *"With pleasure, you are most welcome."* — design-pages Editorial salutation — formal address
- *"Restraint, repeated, becomes a signature."* — design-pages Atelier — three commas, four words, philosophical
- *"A studied hand."* — three words; the determiner does the work
- *"A small, opinionated craftsmanship engine that argues with your AI assistant on your behalf — and wins."* — design-pages Atelier — names the role precisely, embraces the conflict
...
- *"Built to ship."* — design-pages Sport — three words, declarative, with a verb that's a verb
- *"Ready? You are two minutes from shipping."* — design-pages Sport — a question, then a number
- *"design like print: warm, off-register, intentional."* — design-pages Riso — lowercase + colon + three modifiers
...
- *"Hello."* — design-pages Coral salutation — one word; the period is the design
...
- *"A quiet skill."* — design-pages Coral — three words; the article is doing work
- *"Software can be soft and exact at once. That's the trick."* — design-pages Hum — names the contradiction, names the resolution
