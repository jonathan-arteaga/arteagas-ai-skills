...
| **The Future** | (in repo) | design-pages' own body workhorse | Default design-pages tone |
...
| Family | Source | Voice | Best for |
| --- | --- | --- | --- |
| **Geist Mono** | Google | Geist's mono companion | Default design-pages mono, code, captions |
...
| **Workshop** *(design-pages' own theme)* | Free | The Future · Geist · Cabinet Grotesk | The Future · Switzer | The Future Mono · Geist Mono |
...
Pick a ratio. The default for design-pages work is **1.25** (major third). Build the scale from a 16px body, then clamp display sizes for responsive.
