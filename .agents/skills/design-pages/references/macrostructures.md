...
**Pick one. Then read ONLY that one file** from `references/macrostructures/`. Do not load the whole catalogue. Slugs identify the reference files. No stamp, rotation, or design log is required.
