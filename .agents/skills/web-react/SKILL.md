...
For the complete guide with all rules expanded: [references/compiled.md](references/compiled.md)

## Report

Lead with the React or Next.js change. State which performance rules applied, what was verified, and what remains.
