...
- Existing agent instruction files (`AGENTS.md`, `CLAUDE.md`) and undocumented scripts or commands
...
- Add or update `AGENTS.md` (or the host's equivalent, such as `CLAUDE.md`) only with durable repository-specific guidance.
