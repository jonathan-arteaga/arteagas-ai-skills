<!--
Bundled snapshot of Vercel's Web Interface Guidelines, for hosts without network access.
Source: https://github.com/vercel-labs/web-interface-guidelines/blob/main/command.md
Commit: e3d624baaf29dc1fc645aff3e38f03e564d2d6b1 (2026-08-18)
License: MIT, Copyright (c) 2025 Vercel Labs. See ../LICENSE for the stacked notice.
Prefer the live file when it can be fetched; refresh this copy when the upstream changes.
-->

# Web Interface Guidelines (bundled snapshot)
